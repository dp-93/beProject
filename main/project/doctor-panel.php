...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../project/imgg/logo.png" />
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-hospital-o" aria-hidden="true"></i> VirtualHelth care Pro</a>
...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="http://localhost/chat/main/" > Live chat</a>
      <a class="list-group-item list-group-item-action" href="http://localhost/main/project/ivstream/main/index.html" > Live Meeting</a>
      ...
      <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
              ...
              <div class="row">
               ...
               <div class="col-sm-4" style="left: 10%">
                ...
                <div class="col-sm-4" style="margin: 0 auto; margin-top: 5%; padding-left: 325px;">
    <div class="panel panel-white no-radius text-center">
        <div class="panel-body">
            ...
            <h4 class="StepTitle" style="margin-top: 5%;">Live Metting</h4>
            <p class="cl-effect-1">
                <a href="http://localhost/main/project/ivstream/main/index.html" onclick="clickDiv('#list-adoc-list')">Start Meeting</a>
            </p>
        </div>
    </div>
</div>
